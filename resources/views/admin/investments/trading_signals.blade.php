		...
		<div class="col-sm-12 col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="m-0 align-self-center">Signal: <span class="text-primary">{{ $tradingSignal->signal }}</span></h4>
					<label class="mb-0 mt-3 text-muted">AT: <span class="text-primary">{{ $tradingSignal->entry }}</span></label><br>
					<label class="mb-0 mt-3 text-muted">SL: <span class="text-danger">{{ $tradingSignal->stop_loss }}</span> </label>
					...
					@endif
						...
						<br>
					<label class="mb-0 mt-3 text-muted">TP: <span class="text-success">{{ $tradingSignal->take_profit }}</span></label><br>
					@if($tradingSignal->price > 0)
