var options = {
	chart: {height: 346, type: "line", zoom: {enabled: !1}, toolbar: {show: !1}},
	dataLabels: {enabled: !1},
	stroke: {width: 3, curve: "smooth", dashArray: [0, 8]},
	series: [{name: "2019", data: [45, 52, 38, 24, 33, 56, 42, 20, 6, 18, 22, 10]}, {
		name: "2018",
		type: "area",
...
(chart = new ApexCharts(document.querySelector("#earning-yearly-chart"), options)).render(), $("#usa").vectorMap({
	...
	color: "#3d8ef8",
	borderColor: "#bcbfc7",
	colors: {ca: "#5b9ff9", tx: "#5b9ff9", mt: "#5b9ff9", ny: "#5b9ff9"},
...
options = {
	...
	series: [{name: "Facebook", data: [80, 50, 45, 40, 100, 20]}, {name: "Twitter", data: [60, 65, 22, 89, 76, 75]}],
	markers: {size: 0},
	colors: ["#3d8ef8", "#11c46e"],
